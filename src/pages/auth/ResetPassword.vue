  ...
  <div class="min-h-screen flex items-center justify-center bg-[var(--bg)] px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
      <div class="text-center">
        ...
        <h2 class="mt-2 text-lg font-medium text-[var(--text-secondary)]">Set your new password</h2>
      </div>

      <div class="mt-8 bg-[var(--surface-elevated)] py-8 px-4 shadow-brutal-md sm:px-10">
        <div v-if="!token" class="text-center">
          <p class="text-sm text-[var(--danger)]">Invalid or missing reset token.</p>
          <div class="mt-4">
            <router-link to="/forgot-password" class="font-medium text-[var(--accent-primary)] hover:text-[var(--accent-primary-hover)]">
        ...
        <form v-else class="space-y-6" @submit.prevent="handleSubmit">
          ...
          <div>
            <label for="password" class="block text-sm font-medium text-[var(--text-primary)]">New Password</label>
            <div class="mt-1">
              <input
                id="password"
                v-model="password"
            ...
            <div class="mt-3 space-y-2">
              <p class="text-xs font-medium text-[var(--text-secondary)]">Password requirements:</p>
              <div class="space-y-1">
                <div class="flex items-center text-xs">
                  <svg v-if="requirements.length" class="h-4 w-4 text-[var(--success)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
                  <svg v-else class="h-4 w-4 text-[var(--text-secondary)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v3.586L7.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 10.586V7z" clip-rule="evenodd" />
                  </svg>
                  <span :class="requirements.length ? 'text-[var(--success)]' : 'text-[var(--text-secondary)]'">
                    At least 10 characters
                  </span>
                </div>
                <div class="flex items-center text-xs">
                  <svg v-if="requirements.uppercase" class="h-4 w-4 text-[var(--success)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
                  <svg v-else class="h-4 w-4 text-[var(--text-secondary)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v3.586L7.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 10.586V7z" clip-rule="evenodd" />
                  </svg>
                  <span :class="requirements.uppercase ? 'text-[var(--success)]' : 'text-[var(--text-secondary)]'">
                    One uppercase letter
                  </span>
                </div>
                <div class="flex items-center text-xs">
                  <svg v-if="requirements.lowercase" class="h-4 w-4 text-[var(--success)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
                  <svg v-else class="h-4 w-4 text-[var(--text-secondary)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v3.586L7.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 10.586V7z" clip-rule="evenodd" />
                  </svg>
                  <span :class="requirements.lowercase ? 'text-[var(--success)]' : 'text-[var(--text-secondary)]'">
                    One lowercase letter
                  </span>
                </div>
                <div class="flex items-center text-xs">
                  <svg v-if="requirements.number" class="h-4 w-4 text-[var(--success)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
                  <svg v-else class="h-4 w-4 text-[var(--text-secondary)] mr-1.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v3.586L7.707 9.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 10.586V7z" clip-rule="evenodd" />
                  </svg>
                  <span :class="requirements.number ? 'text-[var(--success)]' : 'text-[var(--text-secondary)]'">
                    One number
                  </span>
                </div>
              </div>
          ...
          <div>
            ...
            <p v-if="confirmPassword && password !== confirmPassword" class="mt-1 text-xs text-[var(--danger)]">
