...
import StatsGrid from '@/modules/dashboard/components/StatsGrid.vue';
import TasksByStatusChart from '@/modules/dashboard/components/TasksByStatusChart.vue';
import ProjectCompletionChart from '@/modules/dashboard/components/ProjectCompletionChart.vue';
import ActivityFeed from '@/modules/dashboard/components/ActivityFeed.vue';
import GettingStarted from '@/modules/dashboard/components/GettingStarted.vue';
import ClientHealthWidget from '@/modules/dashboard/components/ClientHealthWidget.vue';
import OutstandingInvoices from '@/modules/dashboard/components/OutstandingInvoices.vue';
